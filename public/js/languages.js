  ...
  passwordResetFailed: "Failed to reset password"
    ...
    masterDB: {
      ...
      googleSheets: {
        ...
        description: "Admins register a sheet URL, choose a tab, and link products with a defect group. Tablet submissions are automatically appended using this saved mapping.",
        loading: "Loading...",
        loadFailed: "Failed to load: {message}",
        loadTargetsFailed: "Google Sheets targets could not be loaded",
        configured: "Configured",
        notConfigured: "Not configured",
        serviceAccountNotConfigured: "Not configured",
        serviceAccountTitle: "Shared Service Account",
        serviceAccountDescription: "Share the target Google Sheet with this email address as an editor. After sharing, click \"Verify Access\" to retrieve the sheet tabs.",
        emptyState: "No Google Sheets integrations have been registered yet.",
        statusSyncOk: "Synced",
        statusSyncError: "Sync Error",
        statusNotRun: "Not Run",
        productCount: "{count} product(s)",
        notSentYet: "No data has been sent yet",
        registerButton: "Register Google Sheet",
        tableLinkName: "Link Name",
        tableSpreadsheet: "Spreadsheet",
        tableSheet: "Tab",
        tableNgGroup: "Defect Group",
        tableTargetProducts: "Target Products",
        tableLastStatus: "Last Status",
        modalEditTitle: "Edit Google Sheet Integration",
        modalCreateTitle: "Register Google Sheet Integration",
        modalDescription: "Verify the URL, choose a tab and defect group, then run the column check.",
        serviceAccountConfigured: "The server-side service account is configured.",
        serviceAccountMissing: "The service account is not configured. Check the server environment variables.",
        labelField: "Link Name",
        labelPlaceholder: "Example: 300D HQ Google Sheet",
        spreadsheetUrlField: "Google Sheet URL",
        verifyAccess: "Verify Access",
        verifyUrlHint: "Verify the URL first to retrieve the available tabs.",
        sheetField: "Tab",
        sheetPlaceholderAfterVerify: "Select after verifying access",
        sheetPlaceholderSelect: "Select a tab",
        ngGroupField: "Defect Group",
        ngGroupPlaceholder: "Select a defect group",
        targetProductsTitle: "Target Products",
        targetProductsDescription: "The selected product IDs determine the destination. Only choose products in the same defect group.",
        selectAll: "Select All",
        clearAll: "Clear All",
        selectedCount: "{count} selected",
        selectNgGroupHint: "Products appear after selecting a defect group.",
        noProductsForGroup: "There are no products linked to this defect group.",
        columnCheckTitle: "Column Check",
        columnCheckDescription: "Existing headers are matched automatically. Only ambiguous columns need admin review; all others can be created automatically on first sync.",
        checkColumns: "Check Columns",
        enterSpreadsheetUrl: "Please enter a Google Sheet URL.",
        verifyingAccess: "Verifying access...",
        inspectFailedNoAccess: "The Google Sheet could not be accessed",
        shareSheetMessage: "This Google Sheet has not been shared yet. Add {email} as an editor in the sharing settings.",
        accessSuccess: "Access verified: {title} ({count} tabs)",
        accessFailed: "Access failed: {message}",
        selectColumnPrompt: "Please select a column",
        existingColumnOption: "Existing column: {name}",
        createNewColumnOption: "Create new column ({name})",
        allColumnsMatched: "All columns were matched automatically. Missing columns will be added automatically on first sync after saving.",
        reviewNeededMultiple: "Multiple candidates were found; admin review is required.",
        reviewNeededMissing: "No matching column was found. Create a new column or map this field to an existing one.",
        summaryAutoMatched: "Auto Matched",
        summaryNeedsReview: "Needs Review",
        summaryNewColumns: "New Column Candidates",
        matchedFieldsTitle: "Automatically Matched Fields",
        noMatchedFields: "No matching columns were found.",
        mappingRequired: "Please choose a destination for \"{field}\".",
        selectUrlTabGroup: "Please select a URL, tab, and defect group.",
        selectAtLeastOneProduct: "Please select at least one target product.",
        columnCheckFailed: "Column check failed",
        runColumnCheckBeforeSave: "Run \"Check Columns\" before saving.",
        confirmUrlTabGroupProducts: "Please confirm the URL, tab, defect group, and target products.",
        saveFailed: "Failed to save",
        saveSuccess: "Google Sheet integration saved.",
        deleteConfirm: "Delete this Google Sheet integration?",
        deleteFailed: "Failed to delete",
        deleteSuccess: "Google Sheet integration deleted."
      },
  ...
  passwordResetFailed: "パスワードのリセットに失敗しました"
    ...
    masterDB: {
      ...
      googleSheets: {
        ...
        description: "管理者はシートURLを登録し、タブを選び、製品と不良グループを結び付けます。タブレット送信時はここで保存した設定に従って自動追記されます。",
        loading: "読み込み中...",
        loadFailed: "読み込みに失敗しました: {message}",
        loadTargetsFailed: "Google Sheets 連携の読み込みに失敗しました",
        configured: "設定済み",
        notConfigured: "未設定",
        serviceAccountNotConfigured: "未設定",
        serviceAccountTitle: "共有先サービスアカウント",
        serviceAccountDescription: "このメールアドレスを対象の Google Sheet に編集者として共有してください。共有後に「アクセス確認」を押すとタブ一覧を取得できます。",
        emptyState: "登録された Google Sheets 連携はまだありません。",
        statusSyncOk: "同期OK",
        statusSyncError: "同期エラー",
        statusNotRun: "未実行",
        productCount: "{count} 製品",
        notSentYet: "まだ送信されていません",
        registerButton: "Google Sheet を登録",
        tableLinkName: "連携名",
        tableSpreadsheet: "Spreadsheet",
        tableSheet: "タブ",
        tableNgGroup: "不良グループ",
        tableTargetProducts: "対象製品",
        tableLastStatus: "最終状態",
        modalEditTitle: "Google Sheet 連携を編集",
        modalCreateTitle: "Google Sheet 連携を登録",
        modalDescription: "URLを確認し、タブと不良グループを選択してから列チェックを行います。",
        serviceAccountConfigured: "サーバー側のサービスアカウントは設定済みです。",
        serviceAccountMissing: "サービスアカウントが未設定です。サーバー環境変数を確認してください。",
        labelField: "連携名",
        labelPlaceholder: "例: 300D 本社 Google Sheet",
        spreadsheetUrlField: "Google Sheet URL",
        verifyAccess: "アクセス確認",
        verifyUrlHint: "まず URL を確認して、利用可能なタブを取得してください。",
        sheetField: "タブ",
        sheetPlaceholderAfterVerify: "アクセス確認後に選択",
        sheetPlaceholderSelect: "タブを選択",
        ngGroupField: "不良グループ",
        ngGroupPlaceholder: "不良グループを選択",
        targetProductsTitle: "対象製品",
        targetProductsDescription: "選択した製品IDで連携先を判定します。同じ不良グループ内の製品だけを選んでください。",
        selectAll: "すべて選択",
        clearAll: "すべて解除",
        selectedCount: "{count} 件選択中",
        selectNgGroupHint: "不良グループを選択すると製品が表示されます。",
        noProductsForGroup: "この不良グループに紐付いた製品がありません。",
        columnCheckTitle: "列チェック",
        columnCheckDescription: "既存ヘッダーを自動判定します。曖昧な列だけ管理者が選び、それ以外は自動で新しい列を作成できます。",
        checkColumns: "列をチェック",
        enterSpreadsheetUrl: "Google Sheet URL を入力してください。",
        verifyingAccess: "アクセス確認中...",
        inspectFailedNoAccess: "Google Sheet にアクセスできませんでした",
        shareSheetMessage: "この Google Sheet はまだ共有されていません。Google Sheet の共有設定で {email} を編集者として追加してください。",
        accessSuccess: "アクセス成功: {title} ({count} タブ)",
        accessFailed: "アクセス失敗: {message}",
        selectColumnPrompt: "列を選択してください",
        existingColumnOption: "既存列: {name}",
        createNewColumnOption: "新しい列を作成 ({name})",
        allColumnsMatched: "すべての列を自動判定できました。保存すると不足列は初回送信時に自動追加されます。",
        reviewNeededMultiple: "候補が複数あるため管理者の確認が必要です。",
        reviewNeededMissing: "一致する列が見つからないため、新しい列を作成するか既存列へ割り当ててください。",
        summaryAutoMatched: "自動一致",
        summaryNeedsReview: "確認が必要",
        summaryNewColumns: "新規列候補",
        matchedFieldsTitle: "自動判定済みフィールド",
        noMatchedFields: "一致した列はありません。",
        mappingRequired: "「{field}」の割り当て先を選択してください。",
        selectUrlTabGroup: "URL、タブ、不良グループを選択してください。",
        selectAtLeastOneProduct: "対象製品を1件以上選択してください。",
        columnCheckFailed: "列チェックに失敗しました",
        runColumnCheckBeforeSave: "保存前に「列をチェック」を実行してください。",
        confirmUrlTabGroupProducts: "URL、タブ、不良グループ、対象製品を確認してください。",
        saveFailed: "保存に失敗しました",
        saveSuccess: "Google Sheet 連携を保存しました。",
        deleteConfirm: "この Google Sheet 連携を削除しますか？",
        deleteFailed: "削除に失敗しました",
        deleteSuccess: "Google Sheet 連携を削除しました。"
      },
